...
from flipsidegram.users import serializers as user_serializers
from flipsidegram.notifications import views as notification_views
...
#         # all_comments = models.Comment.objects.filtter(id=1)
#         # all_comments = models.Comment.objects.filtter(creator=user_id)
